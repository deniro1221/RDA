...
public class UnosProizvod extends JDialog {
	...
	public UnosProizvod() {
		...
		{
			JLabel lblNewLabel = new JLabel("Unos proizvod");
		...
		}
		{
			...
			lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
			lblNewLabel_1.setBounds(10, 105, 78, 13);
			contentPanel.add(lblNewLabel_1);
		}
		{
			JLabel lblNewLabel_1 = new JLabel("Marka");
			lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
			lblNewLabel_1.setBounds(10, 145, 78, 13);
			contentPanel.add(lblNewLabel_1);
		}
		{
			JLabel lblNewLabel_1 = new JLabel("Cijena proizvoda");
			lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
			lblNewLabel_1.setBounds(10, 184, 94, 13);
			contentPanel.add(lblNewLabel_1);
		}
		{
